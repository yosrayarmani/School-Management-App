...
public class Gestion_Eleve extends JFrame implements ActionListener {
	...
	{ 
     ...
     p.setLayout(null);
     JLabel lbnum=new JLabel("Numero d'élève");
     JLabel lbnom=new JLabel("Nom d'élève");
     JLabel lbpren=new JLabel("Prenom d'élève");
